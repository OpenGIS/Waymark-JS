...
This is the full source code for the Waymark Map Editor:
    ...
    */
            ...
            switch (true) {
                case layer instanceof Waymark_L.Circle:
                    layer.feature.properties =
                        Waymark.config.shape_data_defaults;
                ...
                case layer instanceof Waymark_L.Polyline:
                    layer.feature.properties =
                        Waymark.config.line_data_defaults;
    ...
    this.create_buttons = function () {
        ...
        var edit_toolbar_control = Waymark_L.Control.extend({
            ...
            onAdd: function (map) {
                ...
                button.setAttribute(
                    "title",
                    waymark_js.lang.add_rectangle_title,
                );
                button.onclick = function () {
    ...
    this.build_content = function (layer_type, feature, layer) {
        ...
        if (layer_type == "line") {
            ...
            jq_line_direction_select.append(
                ...
                jQuery("<option />")
                    .val("reverse")
                    .text(
                        Waymark.title_case(waymark_js.lang.reverse_direction),
                    ),
            );
        ...
        for (var i in config_types) {
            //Get Key
            var type_key = Waymark.make_key(
                config_types[i][layer_type + "_title"],
            );
        ...
        jQuery("option", jq_layer_type_select)
            .filter(function () {
                return (
                    jQuery(this).val() ==
                    Waymark.make_key(feature.properties.type)
                );
            })
            .attr("selected", "selected");
                ...
                case "image_large_url":
                    var img_input = jQuery("<input />")
                        .attr({
                            ...
                            placeholder:
                                waymark_js.lang.object_image_placeholder,
                        })
                        .on("change", function () {
                            //Update properties
                    ...
                    if (
                        typeof feature.properties.image_thumbnail_url !==
                        "undefined"
                    ) {
