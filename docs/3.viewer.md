...
Here we are creating a new Viewer Instance initialised with some [Types](./2.map.md#types) and loading GeoJSON data from a file. You can see this example in action [here](../examples/viewer-route.html).
