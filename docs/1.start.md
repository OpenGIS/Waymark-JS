...
Here we are creating a new Viewer Instance, setting some [options](./2.map.md#map-options), and adding a Marker to the Map. You can see this example in action [here](../examples/viewer-pub.html).
