...
- GeoJSON source/sublayer IDs are instance-scoped to avoid collisions:
...
- hit-circle: `waymark-{id}-geojson-layer-{index}-{family}-hit`
...
- `src/geojson/createFeaturePropertiesModule.js`
- `src/geojson/createIconImages.js`
